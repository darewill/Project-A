    ...
    <Card>
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          <CardTitle className='text-[20px] italic'>Visiting Chart of Your Company - Interactive</CardTitle>
          <CardDescription className='text-[#656565] font-semibold'>
        ...
        <Select value={timeRange} onValueChange={setTimeRange}>
          ...
          <SelectContent className="rounded-xl focus:outline-none">
            <SelectItem value="90d" className="rounded-lg cursor-pointer hover:bg-[#f3f3f3] p-[5px]">
              Last 3 months
            </SelectItem>
            <SelectItem value="30d" className="rounded-lg cursor-pointer hover:bg-[#f3f3f3] p-[5px]">
              Last 30 days
            </SelectItem>
            <SelectItem value="7d" className="rounded-lg cursor-pointer hover:bg-[#f3f3f3] p-[5px]">
              Last 7 days
            </SelectItem>
          </SelectContent>
        </Select>
      </CardHeader>
      <CardContent className="w-[101%] px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer
          config={chartConfig}
